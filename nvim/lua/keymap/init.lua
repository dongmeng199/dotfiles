...
nmap({
  ...
  -- { ";w", function() vim.cmd('w') end, opts(noremap, silent) },
...
xmap({
  -- vim-camelsnek
  { '<leader>cs', cmd('Snek'), opts(noremap, silent) },
  { '<Leader>cp', cmd('Camel'), opts(noremap, silent) },
  { '<Leader>cc', cmd('CamelB'), opts(noremap, silent) },
  { '<leader>cS', cmd('Screm'), opts(noremap, silent) },
})
